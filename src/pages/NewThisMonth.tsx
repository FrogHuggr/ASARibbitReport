              ...
              >
                ...
                <div className="w-20 h-20 rounded-lg overflow-hidden flex-shrink-0 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-6 h-6 rounded-full bg-[#8B6914] flex items-center justify-center z-10 shadow-md">
                      <span className="font-display font-bold text-[8px] text-white">VS</span>
                    </div>
                  </div>
                </div>
