              ...
              >
                ...
                <div className="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-5 h-5 rounded-full bg-[#8B6914] flex items-center justify-center z-10 shadow-md">
                      <span className="font-display font-bold text-[6px] text-white">VS</span>
                    </div>
                  </div>
                </div>
